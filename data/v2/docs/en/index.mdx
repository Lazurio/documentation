...
The first release is deliberately small: system purpose, operating model,
access boundaries, deployment questions, practical use cases, a Microsoft
Copilot comparison, and machine discovery. It does not claim a certification,
a universal deployment topology, a service level, or that the documented
controls remove the need for your own risk assessment.

English is the accepted source language for this release. Czech will follow as
a curated translation after the English content passes an external IT-reader
test.
